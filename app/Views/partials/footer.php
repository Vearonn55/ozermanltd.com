    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="border-t border-brand-800 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-6 text-sm text-brand-500">
                <a href="<?= url('privacy-policy') ?>" class="hover:text-gold-400 transition-colors">
                    <?= e(t(['en' => 'Privacy Policy', 'tr' => 'Gizlilik Politikası', 'ar' => 'سياسة الخصوصية'])) ?>
                </a>
                <a href="<?= url('cookie-policy') ?>" class="hover:text-gold-400 transition-colors">
                    <?= e(t(['en' => 'Cookie Policy', 'tr' => 'Çerez Politikası', 'ar' => 'سياسة ملفات تعريف الارتباط'])) ?>
                </a>
                <a href="<?= url('cookie-settings') ?>" class="hover:text-gold-400 transition-colors">
