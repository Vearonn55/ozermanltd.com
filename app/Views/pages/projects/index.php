<section class="bg-brand-900 py-20 lg:py-28 relative overflow-hidden">
    <div class="absolute inset-0 opacity-20">
        <img src="<?= e(content()->banner('projects')) ?>" alt="" class="w-full h-full object-cover">
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div x-show="filter === 'all' || filter === '<?= e($project['status']) ?>'"
                 x-transition
                 class="group bg-brand-50 rounded-sm overflow-hidden shadow-sm border border-brand-200 card-hover">
                ...
                <div class="p-6">
                    ...
                    <h2 class="font-display text-xl font-semibold text-brand-800 mb-2">
