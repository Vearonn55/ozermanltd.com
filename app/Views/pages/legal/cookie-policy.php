...
<section class="py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-brand-700">
        <div>
            <h2 class="font-display text-xl font-bold text-brand-800 mb-2"><?= e(t(['en' => 'Essential', 'tr' => 'Gerekli', 'ar' => 'أساسي'])) ?></h2>
        ...
        <div>
            <h2 class="font-display text-xl font-bold text-brand-800 mb-2"><?= e(t(['en' => 'Analytics', 'tr' => 'Analitik', 'ar' => 'التحليلات'])) ?></h2>
        ...
        <div>
            <h2 class="font-display text-xl font-bold text-brand-800 mb-2"><?= e(t(['en' => 'Marketing', 'tr' => 'Pazarlama', 'ar' => 'التسويق'])) ?></h2>
