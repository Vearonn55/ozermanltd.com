<section class="bg-brand-900 py-20 lg:py-28 relative overflow-hidden">
    <div class="absolute inset-0 opacity-20">
        <img src="<?= e(content()->banner('sectors')) ?>" alt="" class="w-full h-full object-cover">
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <a href="<?= url('sectors/' . $sector['slug']) ?>"
               class="group flex gap-6 bg-brand-50 rounded-sm overflow-hidden shadow-sm border border-brand-200 card-hover">
                ...
                <div class="p-6 flex flex-col justify-center">
                    <h2 class="font-display text-2xl font-semibold text-brand-800 group-hover:text-gold-600 transition-colors mb-3">
                        <?= e(t($sector['name'])) ?>
                    </h2>
                    <p class="text-sm text-brand-500 leading-relaxed line-clamp-3 mb-4"><?= e(t($sector['overview'])) ?></p>
                    <span class="text-sm font-semibold text-brand-800 group-hover:text-gold-600 transition-colors">
