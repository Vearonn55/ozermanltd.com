<div class="flex items-center justify-between mb-6">
    <p class="text-sm text-slate-500">Local analytics summary from the database / store.</p>
    <a href="<?= admin_url('analytics/export') ?>" class="text-sm text-blue-600 hover:underline">Export events CSV</a>
</div>
